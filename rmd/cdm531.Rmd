...
*Documentation still in development* CB- describe the table below and what each column means.
create an Rmd file with queries and examples
add era queries 
link to forum posts - race and ethnicity
add cohort table, results schema? REMOVE
make sure v6.0 has bigints for ids
link to csv of cdm
