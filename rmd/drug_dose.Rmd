...
These examples have been curated to show how to calculate drug dose for different drug formulations.
...
Acetaminophen dose = 20 x 500mg = 10,000mg<br><br>
...
`Ingredient dose= quantity x numerator_value [numerator_unit_concept_id]`<br><br>
...
*Acetaminophen dose* = 2 x 1250mg = 2500mg<br><br>
