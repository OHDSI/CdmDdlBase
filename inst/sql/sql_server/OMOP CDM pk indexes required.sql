...
ALTER TABLE @cdmDatabaseSchema.location_history ADD CONSTRAINT xpk_location_history PRIMARY KEY NONCLUSTERED ( location_history_id ) ; --Assuming this should be added
...
CREATE CLUSTERED INDEX idx_source_to_concept_map_id_3 ON @cdmDatabaseSchema.source_to_concept_map (target_concept_id ASC);
CREATE INDEX idx_source_to_concept_map_id_1 ON @cdmDatabaseSchema.source_to_concept_map (source_vocabulary_id ASC);
CREATE INDEX idx_source_to_concept_map_id_2 ON @cdmDatabaseSchema.source_to_concept_map (target_vocabulary_id ASC);
CREATE INDEX idx_source_to_concept_map_code ON @cdmDatabaseSchema.source_to_concept_map (source_code ASC);
...
CREATE CLUSTERED INDEX idx_cohort_definition_id ON @cdmDatabaseSchema.cohort_definition (cohort_definition_id ASC);

CREATE CLUSTERED INDEX idx_attribute_definition_id ON @cdmDatabaseSchema.attribute_definition (attribute_definition_id ASC);
...
CREATE CLUSTERED INDEX idx_observation_period_id ON @cdmDatabaseSchema.observation_period (person_id ASC);

CREATE CLUSTERED INDEX idx_specimen_person_id ON @cdmDatabaseSchema.specimen (person_id ASC);
CREATE INDEX idx_specimen_concept_id ON @cdmDatabaseSchema.specimen (specimen_concept_id ASC);

CREATE CLUSTERED INDEX idx_death_person_id ON @cdmDatabaseSchema.death (person_id ASC);

CREATE CLUSTERED INDEX idx_visit_person_id ON @cdmDatabaseSchema.visit_occurrence (person_id ASC);
CREATE INDEX idx_visit_concept_id ON @cdmDatabaseSchema.visit_occurrence (visit_concept_id ASC);

CREATE CLUSTERED INDEX idx_visit_detail_person_id ON @cdmDatabaseSchema.visit_detail (person_id ASC);
CREATE INDEX idx_visit_detail_concept_id ON @cdmDatabaseSchema.visit_detail (visit_detail_concept_id ASC);

CREATE CLUSTERED INDEX idx_procedure_person_id ON @cdmDatabaseSchema.procedure_occurrence (person_id ASC);
CREATE INDEX idx_procedure_concept_id ON @cdmDatabaseSchema.procedure_occurrence (procedure_concept_id ASC);
CREATE INDEX idx_procedure_visit_id ON @cdmDatabaseSchema.procedure_occurrence (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_drug_person_id ON @cdmDatabaseSchema.drug_exposure (person_id ASC);
CREATE INDEX idx_drug_concept_id ON @cdmDatabaseSchema.drug_exposure (drug_concept_id ASC);
CREATE INDEX idx_drug_visit_id ON @cdmDatabaseSchema.drug_exposure (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_device_person_id ON @cdmDatabaseSchema.device_exposure (person_id ASC);
CREATE INDEX idx_device_concept_id ON @cdmDatabaseSchema.device_exposure (device_concept_id ASC);
CREATE INDEX idx_device_visit_id ON @cdmDatabaseSchema.device_exposure (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_condition_person_id ON @cdmDatabaseSchema.condition_occurrence (person_id ASC);
CREATE INDEX idx_condition_concept_id ON @cdmDatabaseSchema.condition_occurrence (condition_concept_id ASC);
CREATE INDEX idx_condition_visit_id ON @cdmDatabaseSchema.condition_occurrence (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_measurement_person_id ON @cdmDatabaseSchema.measurement (person_id ASC);
CREATE INDEX idx_measurement_concept_id ON @cdmDatabaseSchema.measurement (measurement_concept_id ASC);
CREATE INDEX idx_measurement_visit_id ON @cdmDatabaseSchema.measurement (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_note_person_id ON @cdmDatabaseSchema.note (person_id ASC);
CREATE INDEX idx_note_concept_id ON @cdmDatabaseSchema.note (note_type_concept_id ASC);
CREATE INDEX idx_note_visit_id ON @cdmDatabaseSchema.note (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_note_nlp_note_id ON @cdmDatabaseSchema.note_nlp (note_id ASC);
CREATE INDEX idx_note_nlp_concept_id ON @cdmDatabaseSchema.note_nlp (note_nlp_concept_id ASC);

CREATE CLUSTERED INDEX idx_observation_person_id ON @cdmDatabaseSchema.observation (person_id ASC);
CREATE INDEX idx_observation_concept_id ON @cdmDatabaseSchema.observation (observation_concept_id ASC);
CREATE INDEX idx_observation_visit_id ON @cdmDatabaseSchema.observation (visit_occurrence_id ASC);

CREATE CLUSTERED INDEX idx_survey_person_id ON @cdmDatabaseSchema.survey (person_id ASC);

CREATE INDEX idx_fact_relationship_id_1 ON @cdmDatabaseSchema.fact_relationship (domain_concept_id_1 ASC);
CREATE INDEX idx_fact_relationship_id_2 ON @cdmDatabaseSchema.fact_relationship (domain_concept_id_2 ASC);
CREATE INDEX idx_fact_relationship_id_3 ON @cdmDatabaseSchema.fact_relationship (relationship_concept_id ASC);
...
CREATE CLUSTERED INDEX idx_period_person_id ON @cdmDatabaseSchema.payer_plan_period (person_id ASC);

CREATE CLUSTERED INDEX idx_cost_person_id ON @cdmDatabaseSchema.cost (person_id ASC);
...
CREATE INDEX idx_cohort_subject_id ON @cdmDatabaseSchema.cohort (subject_id ASC);
CREATE INDEX idx_cohort_c_definition_id ON @cdmDatabaseSchema.cohort (cohort_definition_id ASC);

CREATE INDEX idx_ca_subject_id ON @cdmDatabaseSchema.cohort_attribute (subject_id ASC);
CREATE INDEX idx_ca_definition_id ON @cdmDatabaseSchema.cohort_attribute (cohort_definition_id ASC);

CREATE CLUSTERED INDEX idx_drug_era_person_id ON @cdmDatabaseSchema.drug_era (person_id ASC);
CREATE INDEX idx_drug_era_concept_id ON @cdmDatabaseSchema.drug_era (drug_concept_id ASC);

CREATE CLUSTERED INDEX idx_dose_era_person_id ON @cdmDatabaseSchema.dose_era (person_id ASC);
CREATE INDEX idx_dose_era_concept_id ON @cdmDatabaseSchema.dose_era (drug_concept_id ASC);

CREATE CLUSTERED INDEX idx_condition_era_person_id ON @cdmDatabaseSchema.condition_era (person_id ASC);
CREATE INDEX idx_condition_era_concept_id ON @cdmDatabaseSchema.condition_era (condition_concept_id ASC);
